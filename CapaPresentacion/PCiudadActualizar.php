...
$PCa= new PCiudadActualizar();
class PCiudadActualizar{
...
<div class="col-md-12 form-group">
    ...
    <form method="post" >
        ...
        <div class="col-md-7 form-group">
            ...
            <a class="btn btn-orange" href="PCiudad.php">Cancelar</a>
        </div>
    </form>
</div>
<?php
 if (isset($_POST['actualizar'])){
     $nom = $_POST['nombre'];
     $PCa->Actualizar($id,$nom);
     header("location:../CapaPresentacion/PCiudad.php");
 }
?>
</body>
